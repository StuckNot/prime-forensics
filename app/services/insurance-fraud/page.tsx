...
export default function FraudDetectionPage() {
  ...
  <p className="text-typography/70 leading-relaxed text-sm">
    Operating comprehensively for Third Party Administrators and macro insurance providers handling volatile claims.
  </p>
                </div >
              </div >
  ...
  <div className="flex gap-5 items-start">
    ...
    <div>
      <h4 className="font-bold text-primary dark:text-white mb-2 uppercase tracking-wide text-sm">
        Risk & Compliance Collectives
      </h4>
      <p className="text-typography/70 leading-relaxed text-sm">
        Strategic support for Corporate Risk teams and Legal Professionals necessitating rigorous, court-admissible evidence.
      </p>
    </div>
  </div>
            </div >
  ...
  <div className="relative w-full min-h-[400px] h-full bg-primary rounded-2xl overflow-hidden order-1 lg:order-2 shadow-xl border border-secondary/20 flex items-end">
    <Image
      ...
      alt="Investigative tools analysing complex insurance matrices"
      fill
      className="object-cover opacity-80 mix-blend-screen"
    />
    <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/60 to-transparent" />
